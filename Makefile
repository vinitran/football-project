...
DOCKERCOMPOSE_CRAWLER_SCHEDULE := schedule-crawler
DOCKERCOMPOSE_CRAWLER_EXTRACTER := schedule-extracter
...
RUN_CRAWLER_EXTRACTER := $(DOCKERCOMPOSE) up -d $(DOCKERCOMPOSE_CRAWLER_EXTRACTER)
...
STOP_POSTGRES := $(DOCKERCOMPOSE) stop $(DOCKERCOMPOSE_POSTGRES)
STOP_REDIS := $(DOCKERCOMPOSE) stop $(DOCKERCOMPOSE_REDIS)
STOP_GORSE := $(DOCKERCOMPOSE) stop $(DOCKERCOMPOSE_GORSE) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSE_GORSE)
...
STOP_CRAWLER_EXTRACTER := $(DOCKERCOMPOSE) stop $(DOCKERCOMPOSE_CRAWLER_EXTRACTER) && $(DOCKERCOMPOSE) rm -f $(DOCKERCOMPOSE_CRAWLER_EXTRACTER)
